    ...
    <div class="row">
        ...
        <div class="page-content col-xs-12 col-sm-12 col-md-8 col-lg-10 p-3">
            ...
            <div class="card" style="background-color: #fff;">
                {!! Form::open(['route' => 'admin.pages.store', 'method' => 'post','id' =>'submit-form-page']) !!}
                    {!! Form::hidden('parent_id', $parent_page->id) !!}

                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade show active" id="page-content-tab">
                            <div class="card-block">
                                <h4 class="card-title">Parent: {{ $parent_page->heading }}</h4>
                                <h6 class="card-subtitle text-muted">Create Sub Page</h6>
                            </div><!-- /.card-block -->
                    ...
                    <div class="card-block">
                        <div class="form-group">
                            {{--<a href="#" class="btn btn-primary-outline"><i class="fa fa-eye"></i> Preview New Sub</a>--}}
