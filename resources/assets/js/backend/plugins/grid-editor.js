        ...
        self.each(function(baseIndex, baseElem) {
            ...
            function setup() {
                ...
                $.each(settings.new_row_layouts, function(j, layout) {
                    var btn = $('<a class="btn btn-xs btn-primary" />')
                        ...
                        .on('click', function() {
                            var row = createRow(true).appendTo(canvas);
                    ...
                    btn.append('<span class="fa fa-plus"/>');

                    var layoutName = layout.join(' - ');
                    var icon = '<div class="row ge-row-icon">';
                    layout.forEach(function(i) {
                        icon += '<div class="column col-sm-' + i + '"/>';
                    });
                    icon += '</div>';
                    btn.append(icon);
                });
                ...
                var layoutDropdown = $('<div class="dropdown pull-right ge-layout-mode">' +
                    '<button type="button" class="btn btn-sm btn-pingala dropdown-toggle" data-toggle="dropdown"><span>Desktop</span></button>' +
                ...
                var btnGroup = $('<div class="btn-group pull-right"/>')
                    .appendTo(wrapper)
                ;
                var htmlButton = $('<button title="Edit Source Code" type="button" class="btn btn-sm btn-pingala gm-edit-mode"><span class="fa fa-chevron-left"></span><span class="fa fa-chevron-right"></span></button>')
                    .on('click', function() {
            ...
            function createColControls() {
                canvas.find('.column').each(function() {
                    ...
                    createTool(drawer, 'Make column narrower\n(hold shift for min)', 'ge-decrease-col-width', 'fa-minus-square', function(e) {
                    ...
                    createTool(drawer, 'Make column wider\n(hold shift for max)', 'ge-increase-col-width', 'fa-plus-square', function(e) {
                        var colSizes = settings.valid_col_sizes;
                        var curColClass = colClasses[curColClassIndex];
                        var curColSizeIndex = colSizes.indexOf(getColSize(col, curColClass));
            ...
            function createRow(section) {
                if(section == true){
                    return $('<div class="row" data-section="true" />');
                }else{
